import {
  ...
  Triangle, Gear, Plant, Target, Cpu, Mountains, Lightbulb, Image, Lightning,
  
  ChartLineUp, ListNumbers, Vault, LinkSimple, TreeStructure, Graph, ArrowsDownUp, Brain,
  
  ChartBar, ArrowRight, ChartLineDown, MathOperations, Waveform, Compass,
  
  Cube, PuzzlePiece, Function as FunctionIcon,
