...
export function SignInScreen() {
    ...
    return (<div className="signin-screen">
      ...
      <div className="card relative z-[1] w-[min(440px,100%)] py-[2.6rem] px-[2.4rem] text-left">
        ...
        <button className="btn primary w-full justify-center py-[0.8rem] px-[1.3rem] text-[0.95rem]" onClick={signIn}>
