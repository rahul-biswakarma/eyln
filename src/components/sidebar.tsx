...
export function Sidebar() {
    ...
    return (<aside className="sidebar skill-tree" style={{ "--track-accent": accent } as React.CSSProperties}>
      ...
      <div className="st-body">
        ...
        <div className="st-modules">
          ...
          {siblings.map((m) => {
            ...
            return (<Link key={m.id} to={lessonPath(m.id, m.lessons[0].id)} className={"st-mod" + (isCurrent ? " current" : "")}>
