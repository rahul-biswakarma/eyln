...
const dsaChallenges: CodeChallenge[] = [
  ...
  },
  {
    ...
    prompt:
      "Given an integer array <code>nums</code>, move all <code>0</code>s to the end while keeping the relative order of the non-zero elements. Modify in place and return the array.",
    fnName: "moveZeroes",
  ...
  },
  {
    ...
    prompt:
      "Given an array of characters <code>s</code>, reverse it in place and return it. Use O(1) extra memory.",
  ...
  },
  {
    ...
    tags: ["String"],
    prompt:
      "Write a function to find the longest common prefix string amongst an array of strings <code>strs</code>. If there is no common prefix, return the empty string.",
  ...
  },
  {
    ...
    tags: ["String", "Hash Map"],
    prompt:
      "Given a string <code>s</code>, return the index of the first non-repeating character. If none exists, return <code>-1</code>.",
  ...
  },
  {
    ...
    prompt:
      "Given an array of strings <code>strs</code>, group the anagrams together. Return the groups with the words in each group sorted, and the groups sorted by their first word.",
  ...
  },
  {
    ...
    prompt:
      "Given a string <code>s</code>, return <code>true</code> if it reads the same forwards and backwards considering only alphanumeric characters and ignoring case.",
    fnName: "isPalindrome",
  ...
  },
  {
    ...
    prompt:
      "Given a 1-indexed sorted ascending array <code>numbers</code> and a <code>target</code>, return the 1-based indices of the two numbers that add up to <code>target</code>. Exactly one solution exists.",
    fnName: "twoSumII",
  ...
  },
  {
    ...
    prompt:
      "Given <code>height</code> where each element is a vertical line, find two lines that together with the x-axis hold the most water. Return the maximum area.",
    fnName: "maxArea",
  ...
  },
  {
    ...
    tags: ["Stack", "Design"],
    prompt:
      "Simulate a stack that supports O(1) minimum. You are given <code>ops</code>, an array of operations like <code>[\"push\", 3]</code>, <code>[\"pop\"]</code>, <code>[\"top\"]</code>, <code>[\"getMin\"]</code>. Return an array with the results of each <code>top</code> and <code>getMin</code> query, in order.",
    fnName: "minStack",
  ...
  },
  {
    ...
    tags: ["Stack", "Math"],
    prompt:
      "Evaluate the arithmetic expression given in Reverse Polish Notation as a <code>tokens</code> array. Valid operators are <code>+ - * /</code>. Division truncates toward zero.",
    fnName: "evalRPN",
  ...
  },
  {
    ...
    prompt:
      "Merge two ascending-sorted lists <code>l1</code> and <code>l2</code> (given as arrays) into one sorted array and return it.",
  ...
  },
  {
    ...
    tags: ["Linked List", "Two Pointers"],
    prompt:
      "Given a list modeled as the array <code>arr</code>, return the value of the middle node. If there are two middle nodes, return the second one.",
    fnName: "middleNode",
  ...
  },
  {
    ...
    prompt:
      "Given a binary tree as a level-order array <code>arr</code> (using <code>null</code> for missing nodes), return its maximum depth — the number of nodes along the longest root-to-leaf path.",
    fnName: "maxDepth",
  ...
  },
  {
    ...
    tags: ["Tree", "DFS", "Recursion"],
    prompt:
      "Given a binary tree as a level-order array <code>arr</code>, invert it (mirror left/right at every node) and return the inverted tree as a level-order array.",
    fnName: "invertTree",
  ...
  },
  {
    ...
    tags: ["Tree", "DFS", "Recursion"],
    prompt:
      "Given two binary trees as level-order arrays <code>p</code> and <code>q</code>, return <code>true</code> if they are structurally identical with the same node values.",
    fnName: "isSameTree",
  ...
  },
  {
    ...
    tags: ["Sorting", "Array"],
    prompt:
      "Implement bubble sort. Return a new array with the elements of <code>arr</code> in ascending order.",
    fnName: "bubbleSort",
  ...
  },
  {
    ...
    prompt:
      "Implement merge sort. Return a new array with the elements of <code>arr</code> in ascending order.",
    fnName: "mergeSort",
  ...
  },
  {
    ...
    tags: ["Sorting", "Array"],
    prompt:
      "Implement insertion sort. Return a new array with the elements of <code>arr</code> in ascending order.",
  ...
  },
  {
    ...
    tags: ["Binary Search", "Array"],
    prompt:
      "Given a sorted array <code>nums</code> of distinct integers and a <code>target</code>, return the index if found, otherwise the index where it would be inserted to keep the array sorted.",
    fnName: "searchInsert",
  ...
  },
  {
    ...
    tags: ["Binary Search", "Array"],
    prompt:
      "An ascending array <code>nums</code> of distinct values is rotated at an unknown pivot. Given a <code>target</code>, return its index or <code>-1</code>. Must run in O(log n).",
  ...
  },
  {
    ...
    prompt:
      "Return the <code>n</code>-th Fibonacci number, where <code>F(0) = 0</code>, <code>F(1) = 1</code>, and <code>F(n) = F(n−1) + F(n−2)</code>.",
    fnName: "fib",
  ...
  },
  {
    ...
    tags: ["DP", "Array"],
    prompt:
      "Given <code>nums</code> where each element is the money in a house, return the maximum you can rob without robbing two adjacent houses.",
    fnName: "rob",
  ...
  },
  {
    ...
    tags: ["DP", "Array"],
    prompt:
      "Given coin denominations <code>coins</code> and an <code>amount</code>, return the fewest coins needed to make that amount, or <code>-1</code> if it cannot be made.",
    fnName: "coinChange",
  ...
  },
  {
    ...
    tags: ["Math", "String"],
    prompt:
      "Return an array of strings for the numbers <code>1</code> to <code>n</code>: <code>\"Fizz\"</code> for multiples of 3, <code>\"Buzz\"</code> for multiples of 5, <code>\"FizzBuzz\"</code> for multiples of both, else the number as a string.",
    fnName: "fizzBuzz",
  ...
  },
  {
    ...
    tags: ["Math", "Euclid"],
    prompt:
      "Return the greatest common divisor of two non-negative integers <code>a</code> and <code>b</code>.",
    fnName: "gcd",
  ...
  },
  {
    ...
    prompt:
      "Given an integer <code>n</code>, return <code>true</code> if it is a power of two (i.e. <code>n = 2^k</code> for some integer <code>k ≥ 0</code>).",
    fnName: "isPowerOfTwo",
