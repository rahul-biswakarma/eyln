...
export const dsaExtraChallenges: CodeChallenge[] = [
  {
    ...
    prompt:
      "Given an array <code>nums</code>, return its running sum where <code>out[i] = nums[0] + nums[1] + ... + nums[i]</code>.",
    fnName: "runningSum",
  ...
  },
  {
    ...
    prompt:
      "Given an array <code>nums</code> of size <code>n</code>, return the majority element — the value that appears more than <code>&lfloor;n/2&rfloor;</code> times. A majority element always exists.",
  ...
  },
  {
    ...
    tags: ["Array", "Rotation"],
    prompt:
      "Rotate array <code>nums</code> to the right by <code>k</code> steps and return the rotated array. <code>k</code> may be larger than the array length.",
    fnName: "rotate",
  ...
  },
  {
    ...
    tags: ["String"],
    prompt:
      "Return the number of vowels (<code>a, e, i, o, u</code>, case-insensitive) in the string <code>s</code>.",
    fnName: "countVowels",
  ...
  },
  {
    ...
    tags: ["String", "Parsing"],
    prompt:
      "Given a string <code>s</code>, reverse the order of the words. A word is a sequence of non-space characters. Collapse multiple spaces and trim leading/trailing spaces, returning words separated by a single space.",
    fnName: "reverseWords",
  ...
  },
  {
    ...
    prompt:
      "Convert a Roman numeral string <code>s</code> to an integer. When a smaller symbol appears before a larger one (e.g. <code>IV</code>, <code>IX</code>), it is subtracted.",
    fnName: "romanToInt",
  ...
  },
  {
    ...
    tags: ["Hash Set", "Array"],
    prompt:
      "Given two integer arrays <code>a</code> and <code>b</code>, return their intersection: each common element appears once. Return the values in ascending order.",
    fnName: "intersection",
  ...
  },
  {
    ...
    prompt:
      "A number is happy if repeatedly replacing it with the sum of the squares of its digits eventually reaches <code>1</code>. Return <code>true</code> if <code>n</code> is happy, otherwise <code>false</code> (it loops forever).",
    fnName: "isHappy",
  ...
  },
  {
    ...
    tags: ["Hash Set", "Array"],
    prompt:
      "Given an unsorted array <code>nums</code>, return the length of the longest run of consecutive integers. Aim for O(n) using a hash set.",
  ...
  },
  {
    ...
    prompt:
      "Given a sorted array <code>nums</code>, remove the duplicates so each value appears once. Return the resulting array of unique values in order.",
  ...
  },
  {
    ...
    prompt:
      "Given an array <code>nums</code> containing only <code>0</code>, <code>1</code>, and <code>2</code>, sort it in place (Dutch National Flag) and return it. Do it in one pass without a library sort.",
    fnName: "sortColors",
  ...
  },
  {
    ...
    tags: ["Two Pointers", "Array"],
    prompt:
      "Given an array <code>nums</code>, return all unique triples <code>[a, b, c]</code> that sum to zero. Sort each triple ascending, and return the list of triples sorted by their first then second element. No duplicate triples.",
    fnName: "threeSum",
  ...
  },
  {
    ...
    tags: ["Two Pointers", "Array"],
    prompt:
      "Given non-negative heights <code>h</code> representing an elevation map where each bar has width 1, return how much rain water it can trap.",
    fnName: "trap",
  ...
  },
  {
    ...
    prompt:
      "Given daily temperatures <code>t</code>, return an array where <code>out[i]</code> is the number of days you must wait after day <code>i</code> for a warmer temperature. If none exists, use <code>0</code>.",
  ...
  },
  {
    ...
    tags: ["Stack", "String"],
    prompt:
      "Decode a string encoded as <code>k[encoded]</code>, meaning the bracketed substring repeats <code>k</code> times. Brackets may nest. Example: <code>3[a2[c]]</code> becomes <code>accaccacc</code>.",
    fnName: "decodeString",
  ...
  },
  {
    ...
    prompt:
      "Each element of <code>asteroids</code> is a moving rock: positive moves right, negative moves left, absolute value is size. When two collide, the smaller explodes; equal sizes both explode; same-direction rocks never meet. Return the surviving asteroids in order.",
  ...
  },
  {
    ...
    prompt:
      "A linked list is given as the array <code>values</code> plus an integer <code>pos</code>: the last node's <code>next</code> points to index <code>pos</code>, or <code>-1</code> for no cycle. Return <code>true</code> if the list has a cycle.",
    fnName: "hasCycle",
  ...
  },
  {
    ...
    prompt:
      "The linked list is given as an array <code>values</code>. Remove the <code>n</code>-th node counting from the end (1-indexed) and return the resulting array.",
  ...
  },
  {
    ...
    prompt:
      "Two numbers are stored as digit arrays <code>l1</code> and <code>l2</code> in reverse order (least significant digit first). Return their sum as a digit array in the same reverse order.",
  ...
  },
  {
    ...
    tags: ["Tree", "BFS"],
    prompt:
      "A binary tree is given as a level-order array with <code>null</code> for missing children. Return its level-order traversal as an array of arrays, one per depth level (top to bottom).",
    fnName: "levelOrder",
  ...
  },
  {
    ...
    tags: ["Tree", "Recursion"],
    prompt:
      "A binary tree is given as a level-order array with <code>null</code> for missing nodes. Return <code>true</code> if the tree is a mirror of itself around its center.",
    fnName: "isSymmetric",
  ...
  },
  {
    ...
    tags: ["Tree", "DFS"],
    prompt:
      "A binary tree is given as a level-order array with <code>null</code> for missing nodes. Return the diameter — the number of edges on the longest path between any two nodes (it need not pass through the root).",
  ...
  },
  {
    ...
    tags: ["Sorting"],
    prompt:
      "Implement selection sort: repeatedly select the minimum of the unsorted suffix and place it next. Return a new ascending array. Do not use the built-in sort.",
  ...
  },
  {
    ...
    prompt:
      "Given an array of <code>intervals</code> where each is <code>[start, end]</code>, merge all overlapping intervals and return the result sorted by start.",
  ...
  },
  {
    ...
    prompt:
      "Given an array <code>nums</code> and integer <code>k</code>, return the <code>k</code>-th largest element (by value, in sorted order — not necessarily distinct).",
  ...
  },
  {
    ...
    prompt:
      "Return the integer square root of a non-negative integer <code>x</code> — that is, <code>&lfloor;&radic;x&rfloor;</code>. Do not use <code>Math.sqrt</code>.",
    fnName: "mySqrt",
  ...
  },
  {
    ...
    prompt:
      "An element is a peak if it is strictly greater than its neighbors (out-of-bounds neighbors count as <code>-&infin;</code>). Given <code>nums</code>, return the index of any peak in O(log n).",
  ...
  },
  {
    ...
    tags: ["Binary Search", "Array"],
    prompt:
      "A sorted array of distinct values <code>nums</code> has been rotated at some pivot. Return the minimum element in O(log n).",
    fnName: "findMin",
  ...
  },
  {
    ...
    tags: ["DP"],
    prompt:
      "Each index of <code>cost</code> is the price to step off that stair. You may start at index 0 or 1 and climb 1 or 2 stairs each move. Return the minimum cost to reach the top (just past the last index).",
  ...
  },
  {
    ...
    prompt:
      "A robot starts at the top-left of an <code>m &times; n</code> grid and may only move right or down. Return the number of distinct paths to the bottom-right corner.",
    fnName: "uniquePaths",
  ...
  },
  {
    ...
    tags: ["DP", "String"],
    prompt:
      "Return the minimum number of single-character insertions, deletions, or substitutions to convert string <code>a</code> into string <code>b</code> (Levenshtein distance).",
    fnName: "minDistance",
  ...
  },
  {
    ...
    tags: ["Math"],
    prompt:
      "Reverse the digits of a signed 32-bit integer <code>x</code>. If the reversed value overflows the range <code>[-2^31, 2^31 - 1]</code>, return <code>0</code>.",
  ...
  },
  {
    ...
    tags: ["Math"],
    prompt:
      "Return <code>true</code> if the integer <code>x</code> reads the same forwards and backwards. Negative numbers are never palindromes.",
  ...
  },
  {
    ...
    tags: ["Math", "Sieve"],
    prompt:
      "Return the number of prime numbers strictly less than a non-negative integer <code>n</code>.",
    fnName: "countPrimes",
