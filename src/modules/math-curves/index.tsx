...
function Bezier() {
    return (<div className="prose">
      ...
      <Code lang="ts" code={`type V2 = [number, number];
...
export const mathCurves: Module = {
    ...
    icon: "〰️",
    track: "math",
    blurb: "Parametric curves and tangents, arc length, curvature, Bézier curves and the Bernstein basis, and splines — the math behind computer-graphics paths.",
    ...
    lessons: [
        {
            ...
            exercises: [
                ...
                },
                {
                    ...
                    validate: (s) => Math.abs(parseFloat(s) - 1.5) < 0.01
            ...
            exercises: [
                {
                    ...
                    validate: (s) => Math.abs(parseFloat(s) - 2 * Math.PI) < 0.01
                ...
                },
                {
                    ...
                    validate: (s) => Math.abs(parseFloat(s) - 6 * Math.PI) < 0.05
                ...
                },
                {
                    ...
                    validate: (s) => Math.abs(parseFloat(s) - 2 * Math.PI * Math.SQRT2) < 0.05
        ...
        },
        {
            ...
            exercises: [
                ...
                },
                {
                    ...
                    starter: "",
                    hint: "κ = 1/R with R = 5.",
                    validate: (s) => Math.abs(parseFloat(s) - 0.2) < 0.01
        ...
        },
        {
            ...
            exercises: [
                ...
                },
                {
                    ...
                    validate: (s) => Math.abs(parseFloat(s) - 4.5) < 0.01
            ...
            exercises: [
                {
                    ...
                    starter: "I would use ",
                    rubric: "Full credit for choosing Catmull–Rom (or an equivalent interpolating spline), justifying it because it passes through the control points, and noting it gives C¹ continuity (tangents match, no kinks). Bonus for mentioning overshoot risk on sharp turns or the centripetal variant. Partial credit for a reasonable choice without the continuity reasoning.",
