...
export const mathVectorCalc: Module = {
    ...
    icon: "🧭",
    track: "math",
    blurb: "Dot and cross products, the gradient and steepest ascent, divergence and curl, directional derivatives, and a gentle intro to line and surface integrals.",
        ...
        },
        {
            ...
            exercises: [
                ...
                },
                {
                    ...
                    starter: "",
                    hint: "∇f = (2, 5); take √(2² + 5²).",
                    validate: (s) => Math.abs(parseFloat(s) - Math.sqrt(29)) < 0.05
                ...
                },
                {
                    ...
                    starter: "",
                    hint: "9·1²·2².",
                    validate: (s) => Math.abs(parseFloat(s) - 36) < 0.01
        ...
        },
        {
            ...
            exercises: [
                ...
                },
                {
                    ...
                    validate: (s) => Math.abs(parseFloat(s) - Math.SQRT2) < 0.05
            ...
            exercises: [
                {
                    ...
                    rubric: "Full credit for recognizing that F · dr = ‖F‖‖dr‖cosθ, that a perpendicular force gives θ = 90° so cosθ = 0, and therefore each contribution to the integral is zero (e.g., centripetal force in circular motion does no work). Partial credit for the right intuition without invoking the dot-product cosine.",
