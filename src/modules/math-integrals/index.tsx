    ...
    },
    {
      ...
      exercises: [
        ...
        },
        {
          ...
          hint: "e¹ − e⁰ = e − 1.",
          validate: (s) =>
            Math.abs(parseFloat(s) - (Math.E - 1)) < 0.05
        ...
        },
        {
          ...
          validate: (s) =>
            Math.abs(parseFloat(s) - Math.sin(1)) < 0.05
        ...
        },
        {
          ...
          hint: "ln(5) − ln(1).",
          validate: (s) =>
            Math.abs(parseFloat(s) - Math.log(5)) < 0.05
    ...
    },
    {
      ...
      exercises: [
        ...
        },
        {
          ...
          validate: (s) =>
            Math.abs(parseFloat(s) - 15 / 4) < 0.01
        ...
        },
        {
          ...
          validate: (s) =>
            Math.abs(parseFloat(s) - (2 * Math.LN2 - 1)) < 0.05
        ...
        },
        {
          ...
          validate: (s) =>
            Math.abs(parseFloat(s) - Math.PI) < 0.05
    ...
    },
    {
      ...
      exercises: [
        ...
        },
        {
          ...
          validate: (s) =>
            Math.abs(parseFloat(s) - 4 / 3) < 0.05
        ...
        },
        {
          ...
          validate: (s) =>
            Math.abs(parseFloat(s) - 2 / Math.PI) < 0.05
        ...
        },
        {
          ...
          validate: (s) =>
            Math.abs(parseFloat(s) - Math.PI / 3) < 0.05
    ...
    },
    {
      ...
      exercises: [
        ...
        },
        {
          ...
          hint: "(1/3)·(0 + 4·1 + 4).",
          validate: (s) =>
            Math.abs(parseFloat(s) - 8 / 3) < 0.05
        ...
        },
        {
          ...
          validate: (s) =>
            Math.abs(parseFloat(s) - 0.708) < 0.01
