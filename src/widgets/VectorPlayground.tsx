...
export function VectorPlayground() {
    ...
    return (<div className="widget">
      ...
      <div className="wbody">
        <canvas ref={canvasRef} style={{ height: 300, cursor: "grab" }} onPointerDown={(e) => { (e.target as Element).setPointerCapture(e.pointerId); pick(e); }} onPointerMove={move} onPointerUp={() => (dragging.current = null)}/>
