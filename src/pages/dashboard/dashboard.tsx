      ...
      <div className="dash-body">
        ...
        <div className="grid-dash">
          <div className="col-stack">
            {next ? (<Link className="card grad continue hover" to={lessonPath(next.module.id, next.lesson.id)}>
              ...
              </Link>) : (<div className="card grad continue">
        ...
        <div className="card">
          {activity.length === 0 ? (<div className="empty-note">No activity yet. Open a lesson and it'll show up here.</div>) : (<div className="activity">
              {activity.map((a) => (<Link key={a.ref.module.id + a.ref.lesson.id} className="row" to={lessonPath(a.ref.module.id, a.ref.lesson.id)} style={{ color: "inherit" }}>
